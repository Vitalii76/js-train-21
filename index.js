...
class Performance {
  ...
  // Визначаємо метод date(), що виводить рядок в консоль `Гурт ${this.#band.name} виступить в ${this.#location} ${this.#date.toLocaleDateString()}`
  #band;
  #location;
  #date;
 ...
 * | band        | "The Beatles"    |
 */
const bassist = new Bassist("Paul McCartne", "бас-гітара", "The Beatles");
